...
public class HealthPolicyTest {
 ...
 @Test public void slowResponseNeedsRepeatedEvidence(){assertFalse(HealthPolicy.evaluate(true,false,1400,1200,0,3).restart);assertTrue(HealthPolicy.evaluate(true,false,1400,1200,2,3).restart);}
