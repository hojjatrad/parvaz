...
public class ProbeOwnershipRegressionTest {
 ...
 @After public void after(){TunnelVpnService.serviceRunning=false;CoreManager.c.stop();CoreManager.c=null;}
 ...
 @Test public void stoppedCoreInvalidatesOldHealthTickerAndQueuedSwitch(){
  TunnelVpnService service=new TunnelVpnService();TunnelVpnService.m ticker=service.new m(15000);service.b=ticker;assertTrue(ticker.isCurrent());
 ...
 @Test public void replacementTickerInvalidatesPreviousOne(){TunnelVpnService service=new TunnelVpnService();TunnelVpnService.m old=service.new m(15000);service.b=old;assertTrue(old.isCurrent());service.b=service.new m(15000);assertFalse(old.isCurrent());assertTrue(service.b.isCurrent());service.switching=true;assertFalse(service.b.isCurrent());}
}
