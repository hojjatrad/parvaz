...
public class TunnelVpnService extends VpnService {
    ...
    public class i implements Runnable {
        ...
        public final void run() {
            ...
            // queryStats() is cumulative and resets when the core restarts, so a
            // negative delta means "core restarted" -> treat this tick as the new base.
            long dUp = up - this.lastUp;
            long dDown = down - this.lastDown;
            if (dUp < 0 || dDown < 0) {
                dUp = 0;
                dDown = 0;
            }
