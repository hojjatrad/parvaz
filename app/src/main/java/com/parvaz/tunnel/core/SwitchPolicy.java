...
final class SwitchPolicy {
 static <T> void rotateUnconfirmed(java.util.List<T> ranked,int offset){if(!ranked.isEmpty())java.util.Collections.rotate(ranked,-Math.floorMod(offset,ranked.size()));}
