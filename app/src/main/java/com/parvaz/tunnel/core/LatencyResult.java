...
public final class LatencyResult {
 public static final int UNTESTED=-1,FAILED=-2,TESTING=-3,UNCONFIRMED=-4,BUSY=-5,CANCELLED=-6,TIMEOUT=-7,TLS_ERROR=-8,HTTP_ERROR=-9,NETWORK_ERROR=-10,START_ERROR=-11,ROUTE_UNVERIFIED=-12,NETWORK_CHANGED=-13;
 private LatencyResult(){}
 public static int scoped(int value,boolean currentNetwork){return currentNetwork||value==CANCELLED?value:NETWORK_CHANGED;}
 ...
 public static int measured(long value){
  ...
  if(value==-25)return START_ERROR;
  if(value==-26)return ROUTE_UNVERIFIED;
