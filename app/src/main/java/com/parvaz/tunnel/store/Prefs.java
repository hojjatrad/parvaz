...
public final class Prefs {
    ...
    /**
     * Application context. Kept so config building can consult the installed geo data;
     * it is the application instance, so holding it leaks nothing.
     */
    ...
    public final void addDailyUsage(long j, long j2) {
        ...
        if (j > 0 || j2 > 0) {
            try {
                ...
                android.util.Log.w("Parvaz/Prefs", "Exception ignored", unused);
            }
        }
    }
