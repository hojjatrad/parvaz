...
public class SettingsActivity extends AppCompatActivity {
    ...
    public void lambda$onCreate$21(View view) {
        try {
            this.f6163c = BackupManager.export(this);
            this.z.launch("parvaz-backup-" + new SimpleDateFormat("yyyyMMdd-HHmm", Locale.US).format(new Date()) + ".json");
        } catch (Exception e2) {
            Snackbar.make(view, getString(R.string.backup_failed, String.valueOf(e2.getMessage())), 0).show();
        }
    }
    ...
    public final void onCreate(Bundle bundle) {
        ...
        findViewById(R.id.save).setOnClickListener(new v(editText, editText2, editText4, editText3, editText5, editText6, editText7, editText14, editText13, editText12, editText11));
    }
}
