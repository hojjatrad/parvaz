...
for original,new in [('Parvaz-1.28.6-arm64.apk','Parvaz-1.28.6-TEST-arm64.apk'),('Parvaz-1.28.6.apk','Parvaz-1.28.6-TEST.apk'),('Parvaz-1.28.6-source.tar.gz','Parvaz-1.28.6-TEST-source.tar.gz')]:shutil.copyfile(src/original,dest/new)
